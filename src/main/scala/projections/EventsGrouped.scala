...
/**
 * Event can only be of type ZoneEvent.ZoneCreated or DistrictEvent.DistrictCreated
 * Note that the inner type is one of the cases of the parent alzebraic data type
 */
